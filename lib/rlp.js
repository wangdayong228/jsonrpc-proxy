...
function encodeHeaderRLP(header) {
    ...
    if (hasbaseFeePerGas || haswithdrawalsHash || hasblobgasUsed || hasexcessBlobGas || hasparentBeaconhash || hasRequestsHash) {
        if (!hasbaseFeePerGas) {
    ...
    if (haswithdrawalsHash || hasblobgasUsed || hasexcessBlobGas || hasparentBeaconhash || hasRequestsHash) {
    ...
    if (hasblobgasUsed || hasexcessBlobGas || hasparentBeaconhash || hasRequestsHash) {
        if (!hasblobgasUsed) {
...
function calculateBlockHash(header) {
    ...
    // console.log("before calculateBlockHash", header);
